...
process.env.npm_package_url = "https://cse-256-f22.github.io/information-foraging-project-zoe-jeanette-martin/";
if (
    process.env.npm_package_url === "put your repository's homepage url here"
) {
    throw new Error(
